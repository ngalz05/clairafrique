  ...
  <div class="about" style="margin-bottom:24px;">
    <div class="box">
      ...
      <p class="muted" style="margin-top:12px;">
        De notre première librairie à Dakar, nous avons étendu notre présence à Rufisque et Thiès, 
    ...
    <div class="grid3">
      ...
      <div class="card">
        <div class="body" style="text-align:center;padding:24px;">
          ...
          <p class="muted">
            Un service personnalisé et des conseils avisés dans nos trois points de vente 
  ...
  <div class="nextEvent" style="margin-bottom:24px;">
    <div>
      ...
      <ul class="check">
        ...
        clubs de lecture</li>
        <li><strong>Services :</strong> commande en ligne, retrait en magasin sous 2h, livraison 
        à domicile, packs rentrée scolaire</li>
      </ul>
    </div>
    <div class="nextBox">
    ...
    <div class="grid3">
      <div class="card">
        <div class="body">
          ...
          <button class="btnMini" style="margin-top:12px;width:100%;" onclick="location.href='{{ route('points-vente') }}'">
            Voir l'adresse
          </button>
        </div>
      </div>
